...
/*
 cycles |= tmu_mask[ch] ^ 0xFFFFFFFF;
*/
// if (tmu_mask[ch]) sh4_sched_request( ch + 8, cycles );
// else sh4_sched_request( ch + 8, -1);
 sh4_sched_request( ch + 8, cycles );
#endif
}
